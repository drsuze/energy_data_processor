...
```
It is normal for this command to print a lot of text logs about the libaries it is installing to the environment.
...
3. With the sample dataset this was originally built from, the processing may take around 1 minute. Once complete, you should see two heatmaps and two tables displaying energy data. The werminal will also have printed out a few logs about the dataset.
